...
echo "  2. Create database service: ./create-db-service.sh"
echo "  3. Run: cf push -f manifest.yml"
echo "  4. The buildpack will detect vendored dependencies and skip npm install"
echo ""
